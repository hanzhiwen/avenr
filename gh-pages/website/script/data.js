var indexData = {
    "en":{
        "who":"I am Avenr",
        "description":"Hi,I am Avenr,Web developer from zhanjiang,Guangdong,China.I am passionate about development,interaction and design.I really love what I do.",
        "btn":[
            {
                "id":"about",
                "content":"About"
    ...
    "zh":{
        "who":"我是Avenr",
        "description":"哈喽，我是Avenr，一名来自中国广东吴川的web开发工程师。我对开发、交互以及设计充满热情。我真的很喜欢我的工作。",
        "btn":[
            {
                "id":"about",
                "content":"关于"
...
var aboutData = {
    "en":{
        "backBtnText":"Back to home",
        "title":"About",
        "description":"Hi,I am Avenr,Web developer from zhanjiang,Guangdong,China.",
    ...
    "zh":{
        "backBtnText":"回到首页",
        "title":"关于",
        "description":"哈喽，我是Avenr，一名来自中国广东吴川的web开发工程师。",
        "content":`总把自己当作一朵花，其实自己什么也不是。当你觉得自己就是一朵花时，问问自己有开出美丽的芬芳吗？总把自己当作一盏灯，其实自己什么也不是。当你觉得自己就是一盏灯时，问问自己有没有照出一席光明？`
    }
}
var footerData = {
    "en":"Copyright 2022.Avenr All rights reserved.",
    "zh":"Copyright 2022.Avenr 版权所有。"
}
var workData = {
    "en":{
        "backBtnText":"Back to home",
